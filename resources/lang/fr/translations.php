...
return [
    ...
    'tables' => [
        'empty_state' => [
            'title' => 'Vous n\'avez aucun modèle récupérable.',
            'description' => 'Lorsque vous supprimez des éléments, ils apparaîtront ici pour être restaurés ou supprimés définitivement.',
        ],
        'columns' => [
