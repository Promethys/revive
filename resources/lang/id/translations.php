...
return [
    ...
    'tables' => [
        'empty_state' => [
            'title' => 'Anda tidak memiliki model yang dapat dipulihkan.',
            'description' => 'Saat Anda menghapus item, item tersebut akan muncul di sini untuk pemulihan atau penghapusan permanen.',
        ],
        'columns' => [
            'model_id' => 'ID Model',
